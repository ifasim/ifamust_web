...
class UserIDView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if userprofile.display_name is not None:
            print("displayName: not empty")
            return Response(obj, status=HTTP_200_OK)
        else:
            userprofile.display_name = obj['displayName']
            userprofile.photo = obj['photo']
            userprofile.uid = obj['uid']
